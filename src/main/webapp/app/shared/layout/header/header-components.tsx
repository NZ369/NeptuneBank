...
export const Mortgage = props => (
  <NavItem>
    <NavLink tag={Link} to="/entity/mortgage" className="d-flex align-items-center">
      <span>Mortgage Calculator</span>
    </NavLink>
  </NavItem>
);

export const ForeignExchange = props => (
  <NavItem>
    <NavLink tag={Link} to="/entity/currency" className="d-flex align-items-center">

...
import com.neptunebank.app.security.jwt.JWTConfigurer;
import com.neptunebank.app.security.jwt.TokenProvider;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		http
			...
			.antMatchers("/api/news/{\\d+}/**").hasAuthority(AuthoritiesConstants.MANAGER)
			.antMatchers("/api/branch/{\\d+}/**").hasAuthority(AuthoritiesConstants.MANAGER)
			.antMatchers("/api/currency").permitAll()
